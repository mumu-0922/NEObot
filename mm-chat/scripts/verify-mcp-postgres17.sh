...
log "applying a fresh 001 -> 095 chain"
...
log "passed (fresh through 095, replay, guarded 076 down/up, metadata, retention, runtime grants, stdio repository lifecycle)"
