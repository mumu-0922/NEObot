...
log "proving clean 082 -> 083 -> 082 -> 099 replay"
...
log "passed (historical 097 boundary, replay to head 099, schema/grants, drift/CAS/ownership lifecycle, guarded down, clean down/up)"
