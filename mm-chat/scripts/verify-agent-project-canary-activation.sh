...
assert activation["properties"]["release"]["properties"]["migrationHead"]["const"]==95
assert plan["properties"]["action"]["properties"]["approval"]["const"]=="per_commit"
assert approval["properties"]["payload"]["properties"]["release"]["properties"]["migrationHead"]["const"]==95
PY
