...
log "rolling back the clean 097 through 083 tails before the Assistant 082 replay"
...
log "proving clean 081 -> 082 -> 081 -> 097 replay"
...
log "passed (fresh through 097, schema/grants, repository ownership/CAS, clean 082 down/up with 083-097 tail replay)"
