...
log "rolling back the clean 089 through 083 tails before the Assistant 082 replay"
...
log "proving clean 081 -> 082 -> 081 -> 089 replay"
...
log "passed (fresh through 089, schema/grants, repository ownership/CAS, clean 082 down/up with 083-089 tail replay)"
