...
log "building and applying 001 -> 082"
...
log "proving clean 081 -> 082 -> 081 -> 082 replay"
...
log "passed (fresh replay, schema/grants, repository ownership/CAS, clean 082 down/up)"
