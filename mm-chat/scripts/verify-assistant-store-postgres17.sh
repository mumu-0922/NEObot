...
log "building and applying 001 -> 087"
...
log "rolling back the clean 087 through 083 tails before the Assistant 082 replay"
...
log "proving clean 081 -> 082 -> 081 -> 087 replay"
...
log "passed (fresh through 087, schema/grants, repository ownership/CAS, clean 082 down/up with 083-087 tail replay)"
