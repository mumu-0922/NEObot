...
log "rolling back the clean 084 and 083 tails before the Assistant 082 replay"
...
log "proving clean 081 -> 082 -> 081 -> 084 replay"
...
log "passed (fresh through 084, schema/grants, repository ownership/CAS, clean 082 down/up with 083-084 tail replay)"
