...
remaining_agent_services = sorted(retired_agent_services & services.keys())
if remaining_agent_services:
    raise SystemExit(
        f"standalone verification: retired Agent services remain: {remaining_agent_services}"
    )
if (
