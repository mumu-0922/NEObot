...
log "applying migrations through schema head 093"
...
[[ "$(psql_command "SELECT max(version) FROM schema_migrations")" == "93" ]]
...
log "peeling and reapplying the empty migrations 093 and 092 tail"
