# Phase 5.1 Chat CRUD API Contract
...
provider streaming, auth, Redis, MinIO, RAG, or browser-data import are added.
...
Not allowed yet: `sessions`, `provider_configs`, `files`,
`message_attachments`, `audit_logs`, Redis, MinIO/S3, SSE, provider adapters,
assistant streaming persistence, RAG, auth, or browser IndexedDB/OPFS import.
