...
- [`chat-stream-api.md`](./chat-stream-api.md) — Phase 5.2/5.3 backend SSE contract for provider-neutral assistant streaming, OpenAI-compatible provider wiring, mock-provider tests, and assistant-message finalization.
