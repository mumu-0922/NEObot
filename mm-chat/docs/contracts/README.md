...
- [`chat-stream-api.md`](./chat-stream-api.md) — Phase 5.2 backend SSE contract for provider-neutral assistant streaming, mock-provider tests, and assistant-message finalization.
