...
- [`agent-runtime.md`](./agent-runtime.md) — G20 package Runtime contracts through G20.10 operations closure, with exact-host production promotion held.
- [`schemas/`](./schemas/) — strict Draft 2020-12 Agent Runtime Manifest, Capability Grant, Runner RPC, Run Event, Cron revision, Skill Draft, operations-policy and production-closure schemas; positive/negative fixtures live under [`fixtures/agent-runtime/`](./fixtures/agent-runtime/).
