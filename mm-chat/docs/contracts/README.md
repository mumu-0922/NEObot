...
- [`agent-runtime.md`](./agent-runtime.md) — implemented G20.1 package admission through G20.7 Draft-only learning control foundations, held Runner isolation/promotion, and future product/cutover contract.
- [`schemas/`](./schemas/) — strict Draft 2020-12 Agent Runtime Manifest, Capability Grant, Runner RPC, Run Event, Cron revision and Skill Draft schemas; positive/negative fixtures live under [`fixtures/agent-runtime/`](./fixtures/agent-runtime/).
