...
- [`agent-runtime.md`](./agent-runtime.md) — G20 package Runtime contracts plus G21.0 exact-host bundle and control-only activation, with execution promotion held.
- [`schemas/`](./schemas/) — strict Draft 2020-12 Agent Runtime Manifest, Capability Grant, Runner RPC, Run Event, Cron revision, Skill Draft, operations-policy, production-closure, staged-activation and exact-host bundle schemas; positive/negative fixtures live under [`fixtures/agent-runtime/`](./fixtures/agent-runtime/).
