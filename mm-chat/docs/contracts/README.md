...
- [`agent-runtime.md`](./agent-runtime.md) — implemented G20.1 no-execute package/manifest admission plus future durable Run/Step/Attempt, Capability Grant, Runner RPC, Prepare/Commit, depth-1 Child Agents, isolation acceptance, and legacy Skill cutover contract.
