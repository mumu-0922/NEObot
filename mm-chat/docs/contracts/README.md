...
- [`agent-runtime.md`](./agent-runtime.md) — G20 package/manifest admission, durable Run/Step/Attempt and lease state, Capability Grant, Runner RPC, Prepare/Commit, depth-1 Child Agents, isolation acceptance, and legacy Skill cutover contract.
