...
Ordinary Chat migrations `096` and `097` advance the application schema head but do not
...
Legacy control-plane tail drills now peel empty `097`, then `096`, before `095`
and restore the current database head to `097`.
