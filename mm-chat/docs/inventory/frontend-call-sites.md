...
7. Keep plugin/agent, voice, image generation, and code execution behind typed
   API-client capability gates. G16 retired browser-local RAG/doc-parse
   authority; live Knowledge now uses the Go client plus the Python worker.
