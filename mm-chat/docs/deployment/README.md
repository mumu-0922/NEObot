...
| [`agent-runtime.md`](./agent-runtime.md)                               | G20.1 Skill supply, G20.2 Orchestrator, G20.3 held `neo-runnerd` source/control foundation, rootless OCI promotion, broker, release, backup/restore, and legacy cutover runbook. |
