...
| [`agent-runtime.md`](./agent-runtime.md)                               | G20.1 no-execute Skill supply chain plus future non-root `neo-runnerd`, rootless OCI probe/isolation, broker, Kill Switch, release, backup/restore, and legacy cutover runbook. |
