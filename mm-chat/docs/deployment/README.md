...
| [`agent-runtime.md`](./agent-runtime.md)                               | G20.1–G20.7 Skill/Orchestrator/Runner/Broker/Child/Cron/Draft-learning held foundations, rootless OCI promotion, backup/restore, and legacy cutover runbook. |
