...
| [`agent-runtime.md`](./agent-runtime.md)                               | G20.1 no-execute Skill supply chain, G20.2 durable Orchestrator control plane, plus future non-root `neo-runnerd`, rootless OCI probe/isolation, broker, release, backup/restore, and legacy cutover runbook. |
