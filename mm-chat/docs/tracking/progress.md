    ...
    - [x] G6.5c Voice live-provider closure; the real image executor, storage,
      ...
      - [x] G6.5c.2 Real voice executor with stored audio artifacts and
        ...
        - [x] G6.5c.2b Real provider-backed voice executor and authorized
          ...
          - [x] G6.5c.2b.4 SiliconFlow TTS production integration: dedicated
                encrypted `VOICE:SILICONFLOW` save/test/activate authority,
...
- [x] G11 Owner parity regression closure: fix live owner-test gaps before any
  ...
  - [x] G11.9 Auto Knowledge and Web-augmented chat: replace the per-message
    ...
    - [x] G11.9F Postgres-encrypted administrator provider configuration,
      ...
      - [x] G11.9F.4 MinerU/Jina admin records and scoped Go credential gateway.
  ...
  - [x] G14 Draggable conversation scrollbar and user-message navigation,
  ...
  - [x] G19 Provider-native Tool Loop and durable process trace, executed in
    ...
    - [x] G19.4 Native Anthropic `tool_use`/`tool_result` continuation with
