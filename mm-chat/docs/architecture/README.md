...
- [`agent-runtime.md`](./agent-runtime.md) — G20 C4/ArchiMate blueprint for admitted package Skills, durable orchestration, non-root `neo-runnerd`, per-Run rootless OCI, brokered authority, depth-1 delegation, Cron/learning, and legacy cutover.
