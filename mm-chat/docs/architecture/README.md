...
- [`agent-runtime.md`](./agent-runtime.md) — G20 C4/ArchiMate blueprint with implemented G20.1 Skill supply, G20.2 durable orchestration, held G20.3 non-root `neo-runnerd`, G20.4 Broker, G20.5 depth-1 delegation, G20.6 durable Cron and G20.7 Draft-only learning source/control foundations, plus future product/cutover groups.
...
- [`phase-15-1-knowledge-control-plane-plan.md`](./phase-15-1-knowledge-control-plane-plan.md) — ordered Go/Postgres identity, Team, Knowledge ACL, Consent, and Outbox implementation slices.
...
- [`phase-15-2c-offline-parser-canonical-ir-plan.md`](./phase-15-2c-offline-parser-canonical-ir-plan.md) — locked no-network C1 plan for sandboxed native parsing, Canonical IR/Source Locator v2, deterministic manifests, quality gates, and hierarchical chunking.
