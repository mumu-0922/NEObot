...
- [`agent-runtime.md`](./agent-runtime.md) — unified Chat/Agent runtime, installed Skills, bounded local Tools, Browser/MCP connectors, artifacts, and retired legacy control plane.
