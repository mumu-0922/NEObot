...
- [`agent-runtime.md`](./agent-runtime.md) — G20 C4/ArchiMate blueprint with the implemented G20.1 no-execute Skill supply chain and future durable orchestration, non-root `neo-runnerd`, rootless OCI, brokered authority, depth-1 delegation, Cron/learning, and legacy cutover.
