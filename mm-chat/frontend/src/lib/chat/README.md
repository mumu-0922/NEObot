...
- `effectiveChatContext.ts` builds the effective provider/search/RAG context for a request; MCP and Package Skill selection are server-authoritative and not injected by the browser.
