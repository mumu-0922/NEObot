        ...
        fetchImpl: async (input, init) => {
          ...
          return new Response(
            [
              ...
              'data: {"type":"agent.progress","runId":"run-1","conversationId":"c1","messageId":"m2","sequence":3,"createdAt":"2026-07-08T00:00:01Z","step":{"id":"m2:generation:1","kind":"generation","status":"running","labelKey":"process.generation","startedAt":"2026-07-08T00:00:01Z"}}',
              "",
