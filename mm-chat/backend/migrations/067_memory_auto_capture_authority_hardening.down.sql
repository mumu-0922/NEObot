-- A canonical auto-promotion is irreversible through schema rollback. Restore
-- the byte-identical migration-066 function only while no promotion history
-- exists.
DO $guard_auto_capture_authority_rollback$
BEGIN
  IF EXISTS (
    ...
    RAISE EXCEPTION USING ERRCODE = '55000',
      MESSAGE = 'MEMORY_AUTO_CAPTURE_AUTHORITY_ROLLBACK_REQUIRES_NO_PROMOTIONS';
  END IF;
END
$guard_auto_capture_authority_rollback$;
