-- Forward-only Tool evidence-profile correction for Memory v2 auto-capture.
-- Migration 067 remains byte-immutable after live application; the v4
-- extraction schema constrains evidence IDs to the hydrated user/assistant
-- role sets before the unchanged SQL authority rechecks them.
