-- Return the exact matched Child plus its containing Parent from the same
-- current-authority hydration boundary.  Child hashes remain the citation
-- authority; Parent text is source-backed answer context only.
