-- Restore migration 044 behavior: Parent locators are again required to
-- equal Child Search locators, while generation mutation remains operator-only.
...
DROP FUNCTION knowledge_locator_summary_is_valid(JSONB);
