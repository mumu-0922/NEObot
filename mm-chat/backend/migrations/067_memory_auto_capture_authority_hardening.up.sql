-- Forward-only authority hardening for Memory v2 production auto-capture.
-- Migration 066 remains byte-immutable after live application; this revision
-- binds canonical promotion to the required Tool profiles, complete committed
-- batches, candidate content hashes, and every retained evidence row.
