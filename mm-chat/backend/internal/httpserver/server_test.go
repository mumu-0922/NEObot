...
func TestAuthRequiredModeRejectsMissingCredentialsAndKeepsPublicRoutes(t *testing.T) {
	...
	protectedRoutes := []struct {
		...
		{method: http.MethodPost, path: "/v1/me/password"},
		...
		{method: http.MethodPost, path: "/v1/admin/providers/SERVER_DEFAULT/discover"},
		...
		{method: http.MethodGet, path: "/v1/memory-health"},
		...
		{method: http.MethodPost, path: "/v1/skills/candidates/zip"},
		{method: http.MethodGet, path: "/v1/skills/store"},
		{method: http.MethodGet, path: "/v1/skills/library"},
