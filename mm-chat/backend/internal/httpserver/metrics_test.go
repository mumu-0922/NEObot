...
func TestNormalizeMetricPathBoundsKnownDynamicRoutes(t *testing.T) {
	tests := map[string]string{
		...
		"/v1/knowledge/collections/11111111-1111-4111-8111-111111111111/documents":                  "/v1/knowledge/collections/{collectionId}/documents",
		"/v1/knowledge/collections/11111111-1111-4111-8111-111111111111/processing-consents":        "/v1/knowledge/collections/{collectionId}/processing-consents",
		"/v1/knowledge/collections/11111111-1111-4111-8111-111111111111/processing-consents/mineru": "/v1/knowledge/collections/{collectionId}/processing-consents/{processor}",
		...
		"/v1/me/knowledge/query-consents":                                                           "/v1/me/knowledge/query-consents",
		...
		"/v1/jobs/non-uuid-job-id/cancel":                                                           "/v1/jobs/{id}/cancel",
		"/v1/mcp/servers":                                                                           "/v1/mcp/servers",
		"/v1/mcp/servers/private/33333333-3333-4333-8333-333333333333":                              "/v1/mcp/servers/{source}/{server}",
		"/v1/mcp/servers/private/33333333-3333-4333-8333-333333333333/validate":                     "/v1/mcp/servers/{source}/{server}/{action}",
		"/v1/mcp/conversations/33333333-3333-4333-8333-333333333333/selection":                      "/v1/mcp/conversations/{conversation}/selection",
		"/v1/mcp/workspaces/33333333-3333-4333-8333-333333333333/selection":                         "/v1/mcp/workspaces/{workspace}/selection",
		...
		"/v1/mcp/marketplace/items/acme/deep-wiki/install":                                          "/v1/mcp/marketplace/items/{identifier}/install",
		"/v1/code/executions":                                                                       "/v1/code/executions",
		...
		"/v1/admin/task-models":                                                                     "/v1/admin/task-models",
		"/v1/files/33333333-3333-4333-8333-333333333333":                                            "/v1/files/{id}",
		"/v1/files/remote":                                                                          "/v1/files/remote",
