...
def test_dispatch_rejects_a_routed_but_unimplemented_format() -> None:
...
def test_fixed_dispatch_has_no_fallback_for_other_router_formats() -> None:
    ...
    with pytest.raises(NativeParseFailure) as observed:
        _parse_selected(ParserFormat.CSV, decoded, NativeParserLimits())
...
def test_locator_validation_binds_source_encoding() -> None:
    ...
    malformed = replace(artifact, source_encoding="gb18030")
