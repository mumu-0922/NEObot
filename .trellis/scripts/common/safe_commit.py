...
Design
------
- Session recording receives the exact journal and workspace index paths that
  its caller wrote and never discovers active tasks or the task archive. Task
  archival uses its separate archive-path helper. Neither workflow stages the
  whole `.trellis/` tree.
