...
| [Agent Runtime](./agent-runtime.md) | Current no-sudo `local_direct`, interactive non-systemd WSL Host workspace lifecycle, and migration-102 deployment/rollback boundary. |
