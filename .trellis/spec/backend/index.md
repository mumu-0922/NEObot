...
| [Agent Runtime](./agent-runtime.md) | Package-Skill admission, durable Run/Step/Attempt, Runner/Broker/delegation/Cron/learning, Agent Center, legacy cutover, and G21.0 control-only activation |
